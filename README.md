...
## Languages used
All files have been written using HTML, CSS and JS.

## Repository structure

All tasks with descriptions can be found in `Lists/` directory. Directories `ListXX/` contain solutions for the tasks.

**Solutions to tasks that were performed as a group exercises can be found in [this repository](https://github.com/janicaleksander/web-technology-lecture).**
